...
/**
 * Minimal Paper-compatible abstract chat event.
 * <p>
 * CustomNameplates reads the {@code message} field reflectively, so the field
 * name and type are kept intentionally compatible.
 */
public abstract class AbstractChatEvent extends PlayerEvent implements Cancellable {
    ...
    private @NotNull ChatRenderer renderer;
    protected @NotNull Component message;
    private boolean cancelled;

    protected AbstractChatEvent(
            final boolean async,
