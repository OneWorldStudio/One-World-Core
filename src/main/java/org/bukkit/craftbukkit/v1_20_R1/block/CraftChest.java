...
public class CraftChest extends CraftLootable<ChestBlockEntity> implements Chest {
    ...
    public Inventory getInventory() {
        ...
        Container nms = ChestBlock.getContainer(blockChest, data, world.getHandle(), this.getPosition(), true);
        if (nms instanceof CompoundContainer compoundContainer) {
