...
public final class Bukkit {
    ...
    /**
     * Gets the Minecraft version of this server implementation.
     *
    ...
    @NotNull
    public static com.oneworldstudiomc.paper.profile.PlayerProfile createProfile(@Nullable UUID uniqueId, @Nullable String name) {
        return (com.oneworldstudiomc.paper.profile.PlayerProfile) server.createPlayerProfile(uniqueId, name);
    }

    @NotNull
    public static com.oneworldstudiomc.paper.profile.PlayerProfile createProfileExact(@Nullable UUID uniqueId, @Nullable String name) {
        return createProfile(uniqueId, name);
    }
