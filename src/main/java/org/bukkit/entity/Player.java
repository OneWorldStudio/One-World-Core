...
public interface Player extends HumanEntity, Conversable, OfflinePlayer, PluginMessageRecipient {
    ...
    /**
     * Kicks player with a rich adventure component message.
     *
     * @param message kick message
     */
    default void kick(@Nullable net.kyori.adventure.text.Component message) {
        this.kickPlayer(message == null ? null : net.kyori.adventure.text.serializer.legacy.LegacyComponentSerializer.legacySection().serialize(message));
    }
     ...
     * @return permission value as tristate
     */
    default @NotNull net.kyori.adventure.util.TriState permissionValue(final @NotNull String permission) {
        if (this.isPermissionSet(permission)) {
            return this.hasPermission(permission) ? net.kyori.adventure.util.TriState.TRUE : net.kyori.adventure.util.TriState.FALSE;
        }
    ...
    /**
     * Gets the last known resource pack status for this player.
     * <p>
     * Can be null when no status has been received from the client yet.
     *
     * @return last known status, or null if unknown
     */
    default @Nullable PlayerResourcePackStatusEvent.Status getResourcePackStatus() {
        return null;
    }
