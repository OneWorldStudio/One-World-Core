...
public interface Entity extends Metadatable, CommandSender, Nameable, PersistentDataHolder, net.kyori.adventure.text.event.HoverEventSource<net.kyori.adventure.text.event.HoverEvent.ShowEntity> {
    ...
    /**
     * Teleports this entity with Paper-style teleport flags.
     * <p>
     * Flags are accepted for plugin compatibility and ignored on this
     * implementation.
     *
     * @param location New location to teleport this entity to
     * @param cause The cause of this teleportation
     * @param flags Paper teleport flags
     * @return <code>true</code> if the teleport was successful
     */
    default boolean teleport(
            @NotNull Location location,
            @NotNull TeleportCause cause,
            @NotNull com.oneworldstudiomc.paper.entity.TeleportFlag... flags
    ) {
        return this.teleport(location, cause);
    }

    /**
     * Compatibility overload for Paper API package names.
     *
     * @param location New location to teleport this entity to
     * @param cause The cause of this teleportation
     * @param flags Paper teleport flags
    ...
    /**
     * Paper-compatible async teleport.
     *
     * @param location destination
     * @return completed future with teleport result
     */
    default @NotNull CompletableFuture<Boolean> teleportAsync(@NotNull Location location) {
     ...
     * @return completed future with teleport result
     */
    default @NotNull CompletableFuture<Boolean> teleportAsync(@NotNull Location location, @NotNull TeleportCause cause) {
        return CompletableFuture.completedFuture(this.teleport(location, cause));
    }

    /**
     * Paper-compatible async teleport with flags.
     *
     * @param location destination
     * @param cause teleport cause
    ...
    default @NotNull CompletableFuture<Boolean> teleportAsync(
        ...
        return CompletableFuture.completedFuture(this.teleport(location, cause, flags));
    }
