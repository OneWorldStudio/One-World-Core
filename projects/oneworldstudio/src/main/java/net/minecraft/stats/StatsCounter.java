...
public class StatsCounter {
   ...
   public void increment(Player p_13024_, Stat<?> p_13025_, int p_13026_) {
      ...
      org.bukkit.event.Cancellable cancellable = org.bukkit.craftbukkit.v1_20_R1.event.CraftEventFactory.handleStatisticsIncrease(p_13024_, p_13025_, this.getValue(p_13025_), i);
