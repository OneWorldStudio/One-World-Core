   ...
   public int performCommand(ParseResults<CommandSourceStack> p_242844_, String p_242841_) {
      ...
      try {
         try {
            ...
            if ((p_242844_.getContext().getNodes().isEmpty())) {
               if (!org.spigotmc.SpigotConfig.unknownCommandMessage.isEmpty()) {
                  builder.append(LegacyComponentSerializer.legacySection().deserialize(org.spigotmc.SpigotConfig.unknownCommandMessage));
               }
            } else {
               builder.color(net.kyori.adventure.text.format.NamedTextColor.RED).append(LegacyComponentSerializer.legacySection().deserialize(CraftChatMessage.fromComponent(ComponentUtils.fromMessage(commandsyntaxexception.getRawMessage()))));
               // Paper end
               if (commandsyntaxexception.getInput() != null && commandsyntaxexception.getCursor() >= 0) {
                  ...
                  builder.append(net.kyori.adventure.text.Component.newline()).append(LegacyComponentSerializer.legacySection().deserialize(CraftChatMessage.fromComponent(mutablecomponent1)));
               }
            }
