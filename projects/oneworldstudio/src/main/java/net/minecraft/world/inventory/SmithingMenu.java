...
public class SmithingMenu extends ItemCombinerMenu {
   ...
   public void createResult() {
      ...
      if (list.isEmpty()) {
         this.resultSlots.setItem(-521, ItemStack.EMPTY);
         CraftEventFactory.callPrepareSmithingEvent(getBukkitView(), this.resultSlots.getBukkitEventItem()); // CraftBukkit
      } else {
         ...
         if (itemstack.isItemEnabled(this.level.enabledFeatures())) {
            ...
            this.resultSlots.setItem(-521, itemstack);
            // CraftBukkit start
            CraftEventFactory.callPrepareSmithingEvent(getBukkitView(), this.resultSlots.getBukkitEventItem());
            // CraftBukkit end
         }
      }
