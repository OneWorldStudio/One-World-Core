               ...
               if (!globalpos.pos().closerToCenterThan(p_258310_.position(), 2.0D) && !p_258310_.assignProfessionWhenSpawned()) {
                  ...
                  if (p_258310_.getVillagerData().getProfession() != VillagerProfession.NONE) {
                     ...
                     Optional.ofNullable(minecraftserver.getLevel(globalpos.dimension())).flatMap((p_22467_) -> {
                        ...
                        VillagerCareerChangeEvent event = CraftEventFactory.callVillagerCareerChangeEvent(p_258310_, CraftVillager.nmsToBukkitProfession(p_22464_), VillagerCareerChangeEvent.ChangeReason.EMPLOYED);
                        if (event.isCancelled()) {
                           return;
                        }
                        p_258310_.setVillagerData(p_258310_.getVillagerData().setProfession(CraftVillager.bukkitToNmsProfession(event.getProfession())));
                        // CraftBukkit end
