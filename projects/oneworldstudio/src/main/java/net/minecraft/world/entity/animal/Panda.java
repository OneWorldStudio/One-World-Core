...
public class Panda extends Animal {
   ...
   protected void pickUpItem(ItemEntity p_29121_) {
      ...
      if (!org.bukkit.craftbukkit.v1_20_R1.event.CraftEventFactory.callEntityPickupItemEvent(this, p_29121_, 0, !(this.getItemBySlot(EquipmentSlot.MAINHAND).isEmpty() && PANDA_ITEMS.test(p_29121_))).isCancelled()) { // CraftBukkit
