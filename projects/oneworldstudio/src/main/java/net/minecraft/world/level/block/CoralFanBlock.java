...
public class CoralFanBlock extends BaseCoralFanBlock {
   ...
   public void tick(BlockState p_221025_, ServerLevel p_221026_, BlockPos p_221027_, RandomSource p_221028_) {
      if (!scanForWater(p_221025_, p_221026_, p_221027_)) {
         // CraftBukkit start
         if (org.bukkit.craftbukkit.v1_20_R1.event.CraftEventFactory.callBlockFadeEvent(p_221026_, p_221027_, this.deadBlock.defaultBlockState().setValue(WATERLOGGED, false)).isCancelled()) {
            return;
         }
         // CraftBukkit end
