   ...
   protected void onHitEntity(EntityHitResult p_37626_) {
      ...
      if (!this.level().isClientSide) {
         ...
         if (entity1 instanceof LivingEntity) {
            ...
            if (flag) {
               if (entity.isAlive()) {
                  ...
                  livingentity.pushHealReason(org.bukkit.event.entity.EntityRegainHealthEvent.RegainReason.WITHER);  // CraftBukkit // Mohist
         ...
         if (flag && entity instanceof LivingEntity) {
            ...
            if (i > 0) {
               livingentity1.pushEffectCause(org.bukkit.event.entity.EntityPotionEffectEvent.Cause.ATTACK);  // CraftBukkit // Mohist
