      ...
      if (this.isInvulnerableTo(p_31050_)) {
         ...
         if (!this.isRemoved() && !this.level().isClientSide) {
            ...
            if (!p_31050_.is(DamageTypeTags.IS_EXPLOSION)) {
               ...
               this.level().explode(this, damagesource, (ExplosionDamageCalculator) null, this.getX(), this.getY(), this.getZ(), event.getRadius(), event.getFire(), Level.ExplosionInteraction.BLOCK);
               // CraftBukkit end
            }
