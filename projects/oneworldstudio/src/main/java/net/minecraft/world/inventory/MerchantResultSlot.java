...
import com.oneworldstudiomc.paper.event.player.PlayerPurchaseEvent;
import com.oneworldstudiomc.paper.event.player.PlayerTradeEvent;
...
public class MerchantResultSlot extends Slot {
   ...
   public void onTake(Player p_150631_, ItemStack p_150632_) {
      ...
      if (merchantoffer != null && player instanceof net.minecraft.server.level.ServerPlayer serverPlayer) {
         ...
         } else if (this.merchant instanceof org.bukkit.craftbukkit.v1_20_R1.inventory.CraftMerchantCustom.MinecraftMerchant) {
