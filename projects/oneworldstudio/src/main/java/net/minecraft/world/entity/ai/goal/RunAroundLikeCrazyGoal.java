   ...
   public void tick() {
      if (!this.horse.isTamed() && this.horse.getRandom().nextInt(this.adjustedTickDelay(50)) == 0) {
         ...
         if (entity instanceof Player) {
            ...
            if (j > 0 && this.horse.getRandom().nextInt(j) < i && (!net.minecraftforge.event.ForgeEventFactory.onAnimalTame(horse, (Player)entity) || !org.bukkit.craftbukkit.v1_20_R1.event.CraftEventFactory.callEntityTameEvent(this.horse, ((org.bukkit.craftbukkit.v1_20_R1.entity.CraftHumanEntity) this.horse.getBukkitEntity().getPassenger()).getHandle()).isCancelled())) {
