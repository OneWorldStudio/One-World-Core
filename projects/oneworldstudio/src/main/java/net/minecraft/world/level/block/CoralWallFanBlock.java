...
public class CoralWallFanBlock extends BaseCoralWallFanBlock {
   ...
   public void tick(BlockState p_221035_, ServerLevel p_221036_, BlockPos p_221037_, RandomSource p_221038_) {
      if (!scanForWater(p_221035_, p_221036_, p_221037_)) {
         // CraftBukkit start
         if (org.bukkit.craftbukkit.v1_20_R1.event.CraftEventFactory.callBlockFadeEvent(p_221036_, p_221037_, this.deadBlock.defaultBlockState().setValue(WATERLOGGED, false).setValue(FACING, p_221035_.getValue(FACING))).isCancelled()) {
            return;
         }
         // CraftBukkit end
