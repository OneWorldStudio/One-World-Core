...
public abstract class AbstractSkeleton extends Monster implements RangedAttackMob {
   ...
   public void performRangedAttack(LivingEntity p_32141_, float p_32142_) {
      ...
      // CraftBukkit start
      org.bukkit.event.entity.EntityShootBowEvent event = org.bukkit.craftbukkit.v1_20_R1.event.CraftEventFactory.callEntityShootBowEvent(this, this.getMainHandItem(), null, abstractarrow, net.minecraft.world.InteractionHand.MAIN_HAND, 0.8F, true);
