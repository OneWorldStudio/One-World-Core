...
public class WaterlilyBlock extends BushBlock {
   ...
   public void entityInside(BlockState p_58164_, Level p_58165_, BlockPos p_58166_, Entity p_58167_) {
      ...
      if (p_58165_ instanceof ServerLevel && p_58167_ instanceof Boat && org.bukkit.craftbukkit.v1_20_R1.event.CraftEventFactory.callEntityChangeBlockEvent(p_58167_, p_58166_, Blocks.AIR.defaultBlockState())) { // CraftBukkit
