   ...
   protected void onHitEntity(EntityHitResult p_37386_) {
      ...
      if (!this.level().isClientSide) {
         ...
         if (!event.isCancelled()) {
            ...
            entity.setSecondsOnFire(event.getDuration());
         }
         // CraftBukkit end
   ...
   protected void onHitBlock(BlockHitResult p_37384_) {
      ...
      if (!this.level().isClientSide) {
         ...
         if (isIncendiary) { // CraftBukkit
            ...
            if (this.level().isEmptyBlock(blockpos) && !org.bukkit.craftbukkit.v1_20_R1.event.CraftEventFactory.callBlockIgniteEvent(level(), blockpos, this).isCancelled()) {
