...
public class BeaconBlockEntity extends BlockEntity implements MenuProvider, Nameable {
   ...
   public AbstractContainerMenu createMenu(int p_58696_, Inventory p_58697_, Player p_58698_) {
      return BaseContainerBlockEntity.canUnlock(p_58698_, this.lockKey, this.getDisplayName()) ? new BeaconMenu(p_58696_, p_58697_, this.dataAccess, ContainerLevelAccess.createFix(this.level, this.getBlockPos())) : null;
   }
