...
public class CoralPlantBlock extends BaseCoralPlantTypeBlock {
   ...
   public void tick(BlockState p_221030_, ServerLevel p_221031_, BlockPos p_221032_, RandomSource p_221033_) {
      if (!scanForWater(p_221030_, p_221031_, p_221032_)) {
         // CraftBukkit start
         if (org.bukkit.craftbukkit.v1_20_R1.event.CraftEventFactory.callBlockFadeEvent(p_221031_, p_221032_, this.deadBlock.defaultBlockState().setValue(WATERLOGGED, false)).isCancelled()) {
            return;
         }
         // CraftBukkit end
