               ...
               if (!path.notStarted() && !path.isDone()) {
                  ...
                  if (blockstate.is(BlockTags.WOODEN_DOORS, (p_201959_) -> {
                     ...
                     if (!doorblock.isOpen(blockstate)) {
                        ...
                        org.bukkit.event.entity.EntityInteractEvent event = new org.bukkit.event.entity.EntityInteractEvent(p_258470_.getBukkitEntity(), org.bukkit.craftbukkit.v1_20_R1.block.CraftBlock.at(p_258470_.level, blockpos));
