...
public class PersistentEntitySectionManager<T extends EntityAccess> implements AutoCloseable {
   ...
   private boolean addEntity(T p_157539_, boolean p_157540_) {
      if (p_157539_ instanceof Entity entity && (BanEntity.check(entity) || net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(new net.minecraftforge.event.entity.EntityJoinLevelEvent(entity, entity.level(), p_157540_)))) return false;
