   ...
   public void channelRead(ChannelHandlerContext p_9686_, Object p_9687_) {
      ...
      try {
         if (bytebuf.readUnsignedByte() == 254) {
            ...
            org.bukkit.event.server.ServerListPingEvent event = org.bukkit.craftbukkit.v1_20_R1.event.CraftEventFactory.callServerListPingEvent(minecraftserver.server, inetsocketaddress.getAddress(), minecraftserver.getMotd(), minecraftserver.getPlayerCount(), minecraftserver.getMaxPlayers()); // CraftBukkit
            ...
            switch (i) {
               ...
               case 1:
                  ...
                  String s = String.format(Locale.ROOT, "\u00a71\u0000%d\u0000%s\u0000%s\u0000%d\u0000%d", 127, minecraftserver.getServerVersion(), event.getMotd(), event.getNumPlayers(), event.getMaxPlayers()); // CraftBukkit
