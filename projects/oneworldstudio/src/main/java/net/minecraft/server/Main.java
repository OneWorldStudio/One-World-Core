      ...
      try {
         ...
         final MinecraftServer dedicatedserver = MinecraftServer.spin((p_129697_) -> {
            ...
            if (gametestEnabled) {
               ...
               dedicatedserver1 = new DedicatedServer(p_129697_, levelstoragesource$levelstorageaccess, packrepository, worldstem, dedicatedserversettings, DataFixers.getDataFixer(), services, LoggerChunkProgressListener::new).worldLoader(worldLoader.get(), optionset);
               // Mohist end
            }
